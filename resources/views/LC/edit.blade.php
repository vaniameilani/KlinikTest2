                ...
                <div style="align-self: stretch; flex-direction: column; justify-content: flex-start; align-items: flex-start; gap: 24px; display: flex">
                    ...
                    <div class="input-col">
                        <div class="input-col-row">
                            <label for="nama_koor" class="form-label" style="text-align: justify; color: #1D1B20; font-size: 16px; font-family: Inter; font-weight: 500; line-height: 24px; word-wrap: break-word">Nama Korwil/Korcam</label>
                            <input type="text" class="form-control @error('nama_koor') is-invalid @enderror" id="nama_koor" placeholder="Masukkan Nama Korwil/Korcam" name="nama_koor" value="{{ $lc->nama_koor }}" style="align-self: stretch; padding: 16px; background: #FAFAFA; border-radius: 5px; border: 1px #DADDE5 solid; justify-content: flex-start; align-items: center; display: inline-flex" required>
                            @error('nama_koor')
                            <div id="validationServerUsernameFeedback" class="invalid-feedback"> {{ $message }} </div>
                            @enderror
                        </div>
                        <div class="input-col-row">
                            <label for="telp_koor" class="form-label b-medium name" >Nomor Telepon Korwil/Korcam</label>
                            <input type="text" class="input-name form-control @error('telp_koor') is-invalid @enderror" id="telp_koor" placeholder="Masukkan Nomor Telepon Korwil/Korcam" name="telp_koor" value="{{ $lc->telp_koor }}" required>
                            @error('telp_koor')
                            <div id="validationServerUsernameFeedback" class="invalid-feedback"> {{ $message }} </div>
                            @enderror
                        </div>
                    ...
                    <div style="align-self: stretch; flex-direction: column; justify-content: flex-start; align-items: flex-start; gap: 8px; display: flex">
                        ...
                        <select class="form-select p-3 align-self-stretch" value="{{ $lc->sumber_data }}" id="sumber_data" name="sumber_data" style="border-radius: 5px; border: 1px #DADDE5 solid;" required>
                            ...
                            <option value="Bazar" style="text-align: justify; color: #1D1B20; font-size: 16px; font-family: Inter; font-weight: 400; line-height: 24px; word-wrap: break-word" {{ $datasource == 'Bazar' ? 'selected' : '' }}>
                                Bazar
                            </option>
                            <option value="Rekomendasi" style="text-align: justify; color: #1D1B20; font-size: 16px; font-family: Inter; font-weight: 400; line-height: 24px; word-wrap: break-word" {{ $datasource == 'Rekomendasi' ? 'selected' : '' }}>
                                Rekomendasi
                            </option>
                        </select>
                        @error('sumber_data')
                    ...
                    <div style="align-self: stretch; flex-direction: column; justify-content: flex-start; align-items: flex-start; gap: 8px; display: flex">
                        ...
                        <div style="align-self: stretch; border-radius: 5px; flex-direction: column; justify-content: center; align-items: flex-start; gap: 4px; display: flex">
                            <input class="form-control @error('scan_lc') is-invalid @enderror p-3 pr-5" type="file" name="scan_lc" id="scan_lc" value="{{ $lc->scan_lc }}" style="align-self: stretch; justify-content: flex-start; align-items: center; display: inline-flex; border-radius: 5px; border: 1px #DADDE5 solid;">
