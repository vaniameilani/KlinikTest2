            ...
            <div style="align-self: stretch; padding-left: 40px; padding-right: 40px; padding-top: 32px; padding-bottom: 32px; background: white; border-radius: 10px; border: 1px #DADDE5 solid; flex-direction: column; justify-content: center; align-items: center; gap: 24px; display: flex">
                ...
                <div style="align-self: stretch; flex-direction: column; justify-content: center; align-items: center; gap: 16px; display: inline-flex">
                    ...
                    <div class="table">
                        ...
                        @if ($data->count() == 0)
                        <div class="text-center p-3 b-medium" style="align-self: stretch; color:#394E91;">Data tidak ditemukan</div>
                        @else
                        @foreach ($data as $row)
                    ...
                    <!-- <div>Data yang belum lengkap sebanyak <button onclick="myFunction()" class="btn btn-primary"> {{ $countnull }} </button> pengguna</div> -->
                    <!-- <div>Data yang belum lengkap sebanyak <a href="/nulldata" class="btn btn-light"> {{ $countnull }} </a>pengguna</div> -->
                    
                    <div id="myDIV" style=" align-self: stretch;border-radius: 5px; border: 1px #DADDE5 solid; flex-direction: column; justify-content: flex-start; align-items: flex-start; display: none">
